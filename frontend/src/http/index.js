...
export const BASE_URL = "https://vit-library-mgmt-system.onrender.com";

export const api = axios.create({
  baseURL: "https://vit-library-mgmt-system.onrender.com/api",
...
api.interceptors.response.use(
  ...
  async (error) => {
    ...
    if (
      ...
      try {
        await axios.get("https://vit-library-mgmt-system.onrender.com/api/auth/refresh-tokens", {
          withCredentials: true,
        });
